...
class tstage01: GameController{
    override func didMove(to view: SKView){
        ...
        //ゴール作成
        addgoal(xp: 10, yp: 10 ,n:0)
        
        addsquare(xp: 0, yp: 0, xs: 1, ys: 5, angle: 0, n: 0)
        addredsquare(xp: 0, yp: 5, xs: 1, ys: 5, angle: 0, n: 0)
        addredsquare(xp: 1, yp: 9, xs: 3, ys: 1, angle: 0, n: 0)
        
        addsquare(xp: 1, yp: 0, xs: 19, ys: 1, angle: 0, n: 0)
        addsquare(xp: 19, yp: 1, xs: 1, ys: 19, angle: 0, n: 0)
        addsquare(xp: 4, yp: 19, xs: 15, ys: 1, angle: 0, n: 0)
        addsquare(xp: 4, yp: 5, xs: 1, ys: 14, angle: 0, n: 0)
        addsquare(xp: 5, yp: 5, xs: 10, ys: 1, angle: 0, n: 0)
        addsquare(xp: 14, yp: 6, xs: 1, ys: 9, angle: 0, n: 0)
        addsquare(xp: 9, yp: 14, xs: 5, ys: 1, angle: 0, n: 0)
        addsquare(xp: 9, yp: 10, xs: 1, ys: 4, angle: 0, n: 0)
        
        addredsquare(xp: 4, yp: 4, xs: 12, ys: 1, angle: 0, n: 0)
        addredsquare(xp: 15, yp: 5, xs: 1, ys: 11, angle: 0, n: 0)
        addredsquare(xp: 8, yp: 15, xs: 7, ys: 1, angle: 0, n: 0)
        addredsquare(xp: 8, yp: 9, xs: 1, ys: 6, angle: 0, n: 0)
        addredsquare(xp: 9, yp: 9, xs: 1, ys: 1, angle: 0, n: 0)
