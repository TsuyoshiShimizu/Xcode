...
class stageS2ViewController: UIViewController,AVAudioPlayerDelegate{
    ...
    override func viewDidLoad() {
        ...
        do{
            let audioPath = Bundle.main.path(forResource: "失われた都市", ofType: "mp3")
        ...
        let ss = stageS2(size: sv.frame.size)
        sv.presentScene(ss)
