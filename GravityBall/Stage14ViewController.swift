...
class stage14ViewController: UIViewController,AVAudioPlayerDelegate{
    ...
    override func viewDidLoad() {
        ...
        do{
            let audioPath = Bundle.main.path(forResource: "THUNDER PIERCE", ofType: "mp3")
        ...
        let ss = stage14(size: sv.frame.size)
        let color = UIColor(red: 209.0/255.0, green:144.0/255.0, blue: 220.0/255.0, alpha: 1)
