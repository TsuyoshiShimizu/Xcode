...
class tstageVC01: UIViewController,AVAudioPlayerDelegate{
    ...
    override func viewDidLoad() {
        ...
        view.addSubview(sv)
        let ss = tstage01(size: sv.frame.size)
        ...
        backButton.addTarget(self, action: #selector(tstageVC01.back(_:)), for: .touchUpInside)
