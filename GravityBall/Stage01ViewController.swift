...
class Stage01ViewController: UIViewController,AVAudioPlayerDelegate{
    ...
    override func viewDidLoad() {
        ...
        do{
        let audioPath = Bundle.main.path(forResource: "フレッシュティー", ofType: "mp3")
        ...
        let ss = Stage01(size: sv.frame.size)
        let color = UIColor(red: 218.0/255.0, green:242.4/255.0, blue: 241.0/255.0, alpha: 1)
