...
class stageS3ViewController: UIViewController,AVAudioPlayerDelegate{
    ...
    override func viewDidLoad() {
        ...
        do{
            let audioPath = Bundle.main.path(forResource: "ネバーエンディングストーリー", ofType: "mp3")
        ...
        let ss = stageS3(size: sv.frame.size)
        let color = UIColor(red: 246.0/255.0, green:224.0/255.0, blue: 202.0/255.0, alpha: 1)
