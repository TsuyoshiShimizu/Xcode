...
class stage11ViewController: UIViewController,AVAudioPlayerDelegate{
    ...
    override func viewDidLoad() {
        ...
        do{
            let audioPath = Bundle.main.path(forResource: "桜花絢爛", ofType: "mp3")
        ...
        let ss = stage11(size: sv.frame.size)
        let color = UIColor(red: 192.0/255.0, green:209.0/255.0, blue: 83.0/255.0, alpha: 1)
